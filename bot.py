...
async def d(ctx,member:discord.Member=None):
 try:
   ...
   embed.add_field(name="**Nitro 10$**",value="Add [**Nitro Bot**](https://discord.com/oauth2/authorize?client_id=858321493258534922&permissions=0&scope=bot) to two of your servers To claim your gift")
